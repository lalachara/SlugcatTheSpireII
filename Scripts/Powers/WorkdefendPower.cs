...
#nullable enable
public sealed class WorkdefendPower : CustomPowerModel
{
  public override string? CustomPackedIconPath => "res://Resource/Powers/WorkDefend48.png";
  public override string? CustomBigIconPath => "res://Resource/Powers/WorkDefend128.png";
 ...
 {
     if (target == base.Owner && dealer != null && props!=ValueProp.Unpowered&&_.UnblockedDamage!=0)
     {
