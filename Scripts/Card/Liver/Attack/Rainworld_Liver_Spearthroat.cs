...

{
    ...
    public override IEnumerable<CardKeyword> CanonicalKeywords => new []{RainworldKeywords.Spear,RainworldKeywords.Nimble,RainworldKeywords.Chuang};

    //public override IEnumerable<CardKeyword> CanonicalKeywords => new []{CardKeyword.Exhaust};


    protected override IEnumerable<DynamicVar> CanonicalVars => [
        new DamageVar(10m, ValueProp.Unblockable |ValueProp.Move),
        new DynamicVar("Chuang",2m),
        new DynamicVar("Nimble",2m)

    ];

    public Rainworld_Liver_Spearthroat() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
