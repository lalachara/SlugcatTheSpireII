...
public class Rainworld_Liver_Spearstabhead:LiverCardModelAtk

{
    ...
    public Rainworld_Liver_Spearstabhead() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
