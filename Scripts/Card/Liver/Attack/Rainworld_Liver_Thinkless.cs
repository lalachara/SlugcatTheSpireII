...
public class Rainworld_Liver_Thinkless:LiverCardModelAtk

{
    ...
    public Rainworld_Liver_Thinkless() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
