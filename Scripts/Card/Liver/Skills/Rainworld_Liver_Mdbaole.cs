...

{
    ...
    {
        await PowerCmd.Apply<MDbaole2>(choiceContext,Owner.Creature, DynamicVars.Strength.BaseValue, base.Owner.Creature, this);
        await PowerCmd.Apply<MDbaole1>(choiceContext,base.Owner.Creature, base.DynamicVars.Dexterity.BaseValue, base.Owner.Creature, this);
        ...
        await PowerCmd.Apply<TiredPower>(choiceContext,Owner.Creature, 1, base.Owner.Creature, this);
