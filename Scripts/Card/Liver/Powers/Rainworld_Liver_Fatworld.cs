...
public class Rainworld_Liver_Fatworld:LiverCardModelPower

{
    ...
    public Rainworld_Liver_Fatworld() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
