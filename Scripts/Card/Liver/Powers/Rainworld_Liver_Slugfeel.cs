...
public class Rainworld_Liver_Slugfeel:LiverCardModelPower

{
    ...
    public Rainworld_Liver_Slugfeel() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
