...
public class Rainworld_Liver_Acidslime:LiverCardModelPower

{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        new DynamicVar("Slime", 6m)
    ];

    public Rainworld_Liver_Acidslime() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    ...
    {
        DynamicVars["Slime"].UpgradeValueBy(3m);
    }
}