...
public abstract class RedCatCardModelAtk : LiverCardModel
{
    ...
    public RedCatCardModelAtk(int energyCost, CardType type, CardRarity rarity, TargetType targetType, bool shouldShowInCardLibrary) : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
