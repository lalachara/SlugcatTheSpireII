...
public class Rainworld_Redcat_Iteration:RedCatCardModelAtk

{
    ...
    public Rainworld_Redcat_Iteration() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
