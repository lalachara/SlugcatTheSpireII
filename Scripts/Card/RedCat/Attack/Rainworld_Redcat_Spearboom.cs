...
public class Rainworld_Redcat_Spearboom:RedCatCardModelAtk

{
    ...
    public Rainworld_Redcat_Spearboom() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        CardModel card = base.CombatState.CreateCard<Rainworld_Redcat_Spear>(base.Owner);
